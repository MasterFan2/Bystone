package com.proton.library.widget.photopicker.adapter;
...
import com.proton.library.widget.photopicker.event.OnItemCheckListener;
...
//      Picasso.with(mContext).load(new File(photo.getPath())).error(R.mipmap.ic_broken_image_black_48dp).into(holder.ivPhoto);
