...
package com.proton.library.widget.picker.time;
...
import com.proton.library.widget.picker.Utils;
import com.proton.library.widget.picker.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute, boolean isStart);
    }
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        radioGroup = (RadioGroup) view.findViewById(R.id.time_picker_rg);
        ...
        mDoneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCallback != null) {
                    if (checkId == R.id.time_picker_start_rb) {
                        mCallback.onTimeSet(mTimePicker, mTimePicker.getHours(), mTimePicker.getMinutes(), true);
                    } else if (checkId == R.id.time_picker_end_rb) {
                        mCallback.onTimeSet(mTimePicker, mTimePicker.getHours(), mTimePicker.getMinutes(), false);
                    }
                }
                dismiss();
            }
